   ...
   @section('content')
     ...
     <div class="index-pro1">
      ...
      <div class="index-pro1-list" >
       <dl>
        ...
        <dd class="ip-text"><a href="{{url('index/proinfo/'.$v->goods_id)}}">{{$v->goods_name}}</a><span></span></dd>
     ...
     <div class="prolist">
      <dl>
       <dt><a href="proinfo.html"><img src="{{asset('/static/index/images/prolist1.jpg')}}" width="100" height="100" /></a></dt>
       <dd>
